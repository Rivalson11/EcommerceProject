...
from .views import ShoppingCartView, PurchaseView, CartItemDeleteView, AddToCartModalView

app_name = 'purchasing'

urlpatterns = [
    path('add-to-cart-modal/<int:product_id>/', AddToCartModalView.as_view(), name='add_to_cart_modal'),
